...
# Generated by qmake (3.0) (Qt 5.0.1) on: Sat May 4 08:33:46 2013
...
INCPATH       = -I/usr/share/qt5/mkspecs/linux-g++-64 -I. -I. -I/usr/include/qt5 -I/usr/include/qt5/QtOpenGL -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
...
dist: 
	@test -d .tmp/glsl-tester1.0.0 || $(MKDIR) .tmp/glsl-tester1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/glsl-tester1.0.0/ && $(COPY_FILE) --parents glwidget.h window.h .tmp/glsl-tester1.0.0/ && $(COPY_FILE) --parents glwidget.cpp main.cpp window.cpp .tmp/glsl-tester1.0.0/ && (cd `dirname .tmp/glsl-tester1.0.0` && $(TAR) glsl-tester1.0.0.tar glsl-tester1.0.0 && $(COMPRESS) glsl-tester1.0.0.tar) && $(MOVE) `dirname .tmp/glsl-tester1.0.0`/glsl-tester1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/glsl-tester1.0.0
...
moc_glwidget.cpp: /usr/include/qt5/QtOpenGL/QGLWidget \
		...
		glwidget.h
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) $(INCPATH) glwidget.h -o moc_glwidget.cpp
