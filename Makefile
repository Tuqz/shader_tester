...
# Generated by qmake (3.0) (Qt 5.0.1) on: Thu May 2 17:18:23 2013
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/glsl-tester1.0.0/ && $(COPY_FILE) --parents glwidget.h .tmp/glsl-tester1.0.0/ && $(COPY_FILE) --parents glwidget.cpp main.cpp .tmp/glsl-tester1.0.0/ && (cd `dirname .tmp/glsl-tester1.0.0` && $(TAR) glsl-tester1.0.0.tar glsl-tester1.0.0 && $(COMPRESS) glsl-tester1.0.0.tar) && $(MOVE) `dirname .tmp/glsl-tester1.0.0`/glsl-tester1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/glsl-tester1.0.0
